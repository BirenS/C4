...
namespace WebApplication5.chinmay_versions.GreetingCardMaker_version9
{
    public partial class GreetingCardMaker_version9 : System.Web.UI.Page
    {
        ...
        protected void cmdUpdate_Click(object sender, EventArgs e)
        {
         ...
         //   if(!Session.IsNewSession)
                Response.Redirect("GreetingCard.aspx");
        }
    }
}